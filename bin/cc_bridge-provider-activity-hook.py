...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Write CC_BRIDGE provider activity status artifacts.')
...
def main() -> int:
    ...
    runtime_dir = str(args.runtime_dir or os.environ.get('CC_BRIDGE_CALLER_RUNTIME_DIR') or '').strip()
    agent_name = str(args.agent_name or os.environ.get('CC_BRIDGE_CALLER_ACTOR') or '').strip()
    ...
    try:
        write_activity(
            ...
            cc_bridge_session_id=os.environ.get('CC_BRIDGE_SESSION_ID'),
