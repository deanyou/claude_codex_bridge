...
const { executablePath, install } = require("./cc-bridge-npm-install");
...
function npmManagedEnvironment(baseEnv = process.env) {
  return {
    ...baseEnv,
    CC_BRIDGE_INSTALL_KIND: "npm",
    CC_BRIDGE_NPM_PACKAGE_NAME: manifest.name,
    CC_BRIDGE_NPM_PACKAGE_ROOT: packageRoot,
    CC_BRIDGE_NPM_PACKAGE_VERSION: manifest.version,
  };
}
