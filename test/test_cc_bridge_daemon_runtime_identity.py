...
from cc_bridge_daemon.services.ownership import OwnershipConflictError
...
def _lease(project_id: str) -> CcbdLease:
    return CcbdLease(
        ...
        socket_path='/old/.cc-bridge/cc_bridge_daemon/cc_bridge_daemon.sock',
        owner_uid=1000,
        boot_id='boot-1',
...
def test_reconcile_inactive_foreign_runtime_rebuilds_lifecycle() -> None:
    ...
    result = reconcile_runtime_project_identity(
        ...
        socket_path='/new/.cc-bridge/cc_bridge_daemon/cc_bridge_daemon.sock',
        keeper_pid=222,
    ...
    assert result.lifecycle.socket_path == '/new/.cc-bridge/cc_bridge_daemon/cc_bridge_daemon.sock'
...
def test_reconcile_matching_identity_is_noop() -> None:
    ...
    result = reconcile_runtime_project_identity(
        ...
        mount_manager=_Manager(),
        occurred_at='2026-07-24T00:01:00Z',
        socket_path='/same/.cc-bridge/cc_bridge_daemon/cc_bridge_daemon.sock',
    )
