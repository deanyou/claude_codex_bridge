...
from provider_backends.qwen.protocol import QwenRequest, QwenResult, extract_reply_for_req, wrap_qwen_prompt
...
def test_qwen_request_dataclass() -> None:
    req = QwenRequest(
        client_id="client-1",
        work_dir="/tmp/test",
        timeout_s=60.0,
...
def test_qwen_result_dataclass() -> None:
    result = QwenResult(
        exit_code=0,
        reply="test reply",
        req_id="abc123",
