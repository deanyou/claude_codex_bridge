...
from cc_bridge_daemon.services.health_monitor_runtime.status import runtime_health
from cc_bridge_daemon.services.health_monitor_runtime.updates_runtime.rebind import rebind_runtime
from cc_bridge_daemon.services.provider_runtime_facts import ProviderRuntimeFacts
...
def test_rebind_runtime_uses_provider_facts_and_clears_degraded_state() -> None:
    ...
    facts = ProviderRuntimeFacts(
        ...
        session_id='sid-9',
        cc_bridge_session_id='cc_bridge-sid-9',
    )
    captured = {}
...
def test_rebind_runtime_falls_back_to_session_binding_when_facts_missing(monkeypatch) -> None:
    ...
    binding = SimpleNamespace(session_id_attr='session_id', session_path_attr='session_path')
    monkeypatch.setattr(
        'cc_bridge_daemon.services.health_monitor_runtime.updates_runtime.rebind.session_ref',
