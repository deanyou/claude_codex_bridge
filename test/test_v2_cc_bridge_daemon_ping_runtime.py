...
from cc_bridge_daemon.handlers.ping_runtime.handler import build_ping_handler
from cc_bridge_daemon.handlers.ping_runtime.payloads import build_agent_payload, build_cc_bridge_daemon_payload
...
def _inspection(
    *,
    phase: str,
    desired_state: str,
    socket_path: str = '/home/demo/.local/state/cc_bridge/projects/proj-1/cc_bridge_daemon/cc_bridge_daemon.sock',
):
...
def _paths() -> SimpleNamespace:
    return SimpleNamespace(
        cc_bridge_daemon_socket_placement=SocketPlacement(
            preferred_path=Path('/home/demo/.local/state/cc_bridge/projects/proj-1/cc_bridge_daemon/cc_bridge_daemon.sock'),
            effective_path=Path('/home/demo/.local/state/cc_bridge/projects/proj-1/cc_bridge_daemon/cc_bridge_daemon.sock'),
            root_kind='runtime',
            fallback_reason=None,
            filesystem_hint=None,
        ),
        cc_bridge_daemon_tmux_socket_placement=SocketPlacement(
            preferred_path=Path('/home/demo/.local/state/cc_bridge/projects/proj-1/cc_bridge_daemon/tmux.sock'),
            effective_path=Path('/home/demo/.local/state/cc_bridge/projects/proj-1/cc_bridge_daemon/tmux.sock'),
            root_kind='runtime',
            fallback_reason=None,
            filesystem_hint=None,
        ),
...
def test_build_cc_bridge_daemon_payload_prefers_lifecycle_phase_over_lease_mount_state() -> None:
    payload = build_cc_bridge_daemon_payload(
        project_id='proj-1',
        config=_config(),
        paths=_paths(),
    ...
    assert payload['socket_path'] == '/home/demo/.local/state/cc_bridge/projects/proj-1/cc_bridge_daemon/cc_bridge_daemon.sock'
    assert payload['preferred_socket_path'] == '/home/demo/.local/state/cc_bridge/projects/proj-1/cc_bridge_daemon/cc_bridge_daemon.sock'
    assert payload['effective_socket_path'] == '/home/demo/.local/state/cc_bridge/projects/proj-1/cc_bridge_daemon/cc_bridge_daemon.sock'
    ...
    assert payload['tmux_socket_path'] == '/home/demo/.local/state/cc_bridge/projects/proj-1/cc_bridge_daemon/tmux.sock'
...
def test_ping_handler_all_uses_lifecycle_phase_for_cc_bridge_daemon_state() -> None:
    config = _config()

    def _unexpected_summary():
        raise AssertionError('cc_bridge_daemon-only summaries should not load for ping all')
    ...
    assert payload['cc_bridge_daemon_state'] == 'starting'
    assert payload['agents'][0]['mount_state'] == 'starting'
    assert payload['agents'][0]['diagnostics']['desired_state'] == 'running'


def test_ping_handler_cc_bridge_daemon_does_not_force_health_check() -> None:
    config = _config()
    ...
    payload = handler({'target': 'cc_bridge_daemon'})
...
def test_build_agent_payload_prefers_runtime_mount_state_over_project_phase() -> None:
    ...
    def _unexpected_summary():
        raise AssertionError('cc_bridge_daemon-only summaries should not load for ping agent')
...
def test_build_cc_bridge_daemon_payload_projects_herdr_namespace_surface() -> None:
    payload = build_cc_bridge_daemon_payload(
...
def test_build_agent_payload_projects_herdr_runtime_surface() -> None:
    ...
    runtime = AgentRuntime(
        ...
        reconcile_state='blocked',
        last_failure_reason='Herdr auto restore observe-only blocks CC_BRIDGE-owned recovery',
    )
...
def test_ping_target_unmounted_cc_bridge_daemon_includes_timing_fields(monkeypatch, tmp_path: Path) -> None:
    ...
    monkeypatch.setattr(
        ...
        lambda _context: SimpleNamespace(
            ...
            health='unmounted',
            generation=0,
            project_anchor_path='/tmp/repo/.cc-bridge',
            runtime_state_root='/tmp/repo/.cc-bridge',
            runtime_root_kind='project',
            runtime_relocation_reason=None,
            runtime_filesystem_hint=None,
            runtime_marker_status='not_required',
            socket_path=None,
            preferred_socket_path='/tmp/repo/.cc-bridge/cc_bridge_daemon/cc_bridge_daemon.sock',
            effective_socket_path='/tmp/repo/.cc-bridge/cc_bridge_daemon/cc_bridge_daemon.sock',
            socket_root_kind='project',
            socket_fallback_reason=None,
            socket_filesystem_hint=None,
            tmux_socket_path='/tmp/repo/.cc-bridge/cc_bridge_daemon/tmux.sock',
            tmux_preferred_socket_path='/tmp/repo/.cc-bridge/cc_bridge_daemon/tmux.sock',
            tmux_effective_socket_path='/tmp/repo/.cc-bridge/cc_bridge_daemon/tmux.sock',
    ...
    payload = ping_target(context, ParsedPingCommand(project=None, target='cc_bridge_daemon'))
...
def test_ping_target_all_uses_non_mutating_probe(monkeypatch) -> None:
    ...
    class _Client:
        def ping(self, target: str) -> dict:
            return {'project_id': 'proj-1', 'cc_bridge_daemon_state': 'mounted', 'agents': [], 'target': target}
