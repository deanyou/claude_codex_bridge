...
from cc_bridge_daemon.services.health_assessment.tmux_runtime.state import tmux_pane_state
...
def test_tmux_pane_state_returns_foreign_when_ownership_mismatches(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "cc_bridge_daemon.services.health_assessment.tmux_runtime.state.inspect_tmux_pane_ownership",
