...
def test_runtime_specs_use_provider_native_names() -> None:
    ...
    assert CODEX_RUNTIME_SPEC.idle_timeout_env == "CC_BRIDGE_CODEX_RUNTIME_IDLE_TIMEOUT_S"
    assert CODEX_RUNTIME_SPEC.lock_name == "codex-runtime"

    assert CODEX_CLIENT_SPEC.provider_key == "codex"
    assert CODEX_CLIENT_SPEC.enabled_env == "CC_BRIDGE_CODEX"
    assert CODEX_CLIENT_SPEC.autostart_env == "CC_BRIDGE_CODEX_AUTOSTART"
    assert CODEX_CLIENT_SPEC.state_file_env == "CC_BRIDGE_CODEX_STATE_FILE"
    assert CODEX_CLIENT_SPEC.session_filename == ".codex-session"
    assert provider_env_name("claude", "PANE_CHECK_INTERVAL") == "CC_BRIDGE_CLAUDE_PANE_CHECK_INTERVAL"
    assert provider_env_name("codebuddy", "REBIND_TAIL_BYTES") == "CC_BRIDGE_CODEBUDDY_REBIND_TAIL_BYTES"
    ...
    assert AGY_RUNTIME_SPEC.idle_timeout_env == "CC_BRIDGE_AGY_RUNTIME_IDLE_TIMEOUT_S"
    assert AGY_CLIENT_SPEC.provider_key == "agy"
    assert AGY_CLIENT_SPEC.state_file_env == "CC_BRIDGE_AGY_STATE_FILE"
