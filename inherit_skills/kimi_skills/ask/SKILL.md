---
name: ask
description: Send a request to a CC_BRIDGE agent with `ask`.
metadata:
  short-description: Ask agent
---

Use this skill when the user asks you to delegate with CC_BRIDGE, or when project
memory says to use CC_BRIDGE `ask` for collaboration.
