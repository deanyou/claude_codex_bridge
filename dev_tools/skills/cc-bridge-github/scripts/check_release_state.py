#!/usr/bin/env python3
"""Read-only release surface checker for the CC_BRIDGE GitHub project."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Check CC_BRIDGE release-facing local and GitHub state.")
    ...
    print(f"CC_BRIDGE release check: {version} ({args.phase})")
