...
def check_readme_surface(
    *,
    ...
    if ".cc-bridge/cc_bridge_memory.md" not in body:
        fail(
            issues,
            f"{source} {readme_name} does not mention .cc-bridge/cc_bridge_memory.md",
    ...
    if "CC_BRIDGE.md" in body:
        fail(
            issues,
            f"{source} {readme_name} mentions current CC_BRIDGE.md support",
            fix="default-branch README should describe only .cc-bridge/cc_bridge_memory.md as current shared memory",
        )
