...
WINDOWS_OWNED_FILES = frozenset(
    {
        ...
        "docs/cc_bridge_daemon-windows-psmux-plan.md",
        "install.cmd",
        "install.ps1",
...
ALLOWED_SHARED_WINDOWS_IMPORTS = frozenset(
    {
        ...
        ("lib/cc_bridge_daemon/app_runtime/service_graph.py", "platforms.windows.herdr.lifecycle_bridge"),
        ("lib/cc_bridge_daemon/control_plane_transport/factory.py", "platforms.windows.control_plane.tcp"),
        ("lib/cc_bridge_daemon/handlers/ping_runtime/payloads.py", "platforms.windows.herdr.cc_bridge_daemon_surface_projection"),
        ("lib/cc_bridge_daemon/project_view/service.py", "platforms.windows.herdr.cc_bridge_daemon_surface_projection"),
        ("lib/cc_bridge_daemon/socket_server_runtime/server.py", "platforms.windows.control_plane.tcp"),
        ...
        ("lib/cli/services/config_ui.py", "platforms.windows.herdr.cc_bridge_daemon_surface_projection"),
        ...
        ("lib/cli/services/doctor_runtime/cc_bridge_daemon.py", "platforms.windows.herdr.surface"),
        ("lib/cli/services/layout_status.py", "platforms.windows.herdr.surface"),
        ("lib/cli/services/ps.py", "platforms.windows.herdr.surface"),
        ("lib/mobile_gateway/service.py", "platforms.windows.herdr.cc_bridge_daemon_surface_projection"),
