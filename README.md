...
CC_BRIDGE 8.6.13 includes the Flutter CC_BRIDGE Mobile source in [`mobile/`](mobile/) and publishes the Android APK through GitHub Releases:

- [Download CC_BRIDGE Mobile v8.6.13 APK](https://github.com/SeemSeam/claude_codex_bridge/releases/download/v8.6.13/cc-bridge-mobile-v8.6.13.apk)
...
<p align="center">
  <img src="assets/weixin.png?v=da517368" alt="CC_BRIDGE WeChat group 2" width="240">
</p>
