...
`dev_tools/skills/cc-bridge-github/scripts/check_release_state.py` was the highest
...
`dev_tools/skills/cc-bridge-github/scripts/` while keeping
...
`check_active_skill_sync` warns when active managed `cc-bridge-github` skill copies
