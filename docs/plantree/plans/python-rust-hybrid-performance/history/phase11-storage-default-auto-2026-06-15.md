...
- Preserved explicit controls:
  - `CC_BRIDGE_RUST_STORAGE_SCAN=0` forces Python inventory.
  - `CC_BRIDGE_RUST_STORAGE_SCAN=1|auto` attempts Rust and falls back to Python.
  - `CC_BRIDGE_RUST_STORAGE_SCAN=required` raises on helper missing/crash/bad
    payload.
