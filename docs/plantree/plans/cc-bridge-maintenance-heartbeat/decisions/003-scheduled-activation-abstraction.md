...
`self`/`cc-bridge_self`, but the same scheduling capability may later need to send
tasks to other configured agents.

## Decision

Model heartbeat dispatch as a reusable CC_BRIDGE scheduled-activation abstraction.
