...
- Interactive startup and `cc-bridge config approve-commands` review flow.
- Non-interactive cc-bridge-daemon bootstrap and reload enforcement.
...
- `648 passed` across the complete `test/test_cc-bridge-daemon*.py` group.
