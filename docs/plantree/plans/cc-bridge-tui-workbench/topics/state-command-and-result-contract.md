...
Scripts and cc-bridge-daemon services own transition validation, persistence, queue
...
future parallel scheduler. High-frequency state remains under CC_BRIDGE runtime
