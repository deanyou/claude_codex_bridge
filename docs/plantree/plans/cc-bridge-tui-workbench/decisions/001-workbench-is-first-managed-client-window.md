...
The user-facing conversation and workflow surface should be the first CC_BRIDGE
...
An opted-in Agentic Loop project gets a built-in `cc-bridge-workbench` window as the
...
`cc-bridge-user`, `cc-bridge-plan`, and dynamic Agent windows.
