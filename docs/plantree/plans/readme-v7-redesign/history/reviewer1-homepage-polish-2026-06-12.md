...
CC_BRIDGE ask job: `job_6092320a91e1`

Artifact:
`.cc-bridge/cc-bridge-daemon/artifacts/text/completion-reply/job_6092320a91e1-art_89d691bcc11a49a2.txt`
...
- Hero asset strategy was blocking. `assets/cc-bridge-promo.png` creates bilingual
