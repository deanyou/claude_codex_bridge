...
- When a tool command exits, should CC_BRIDGE leave the pane open, restart it, or show
...
- If parser readiness fails on a platform, should CC_BRIDGE enable Markview as an
...
- Should CC_BRIDGE offer WezTerm installation/provisioning directly, or should doctor
...
- Should `cc-bridge-yazi-rich` show a visible degraded banner when it automatically
...
- On partial bundle install failure, should CC_BRIDGE roll back generated profiles
