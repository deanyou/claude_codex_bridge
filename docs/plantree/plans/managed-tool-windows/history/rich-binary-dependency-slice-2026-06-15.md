...
Harden `cc-bridge update rich` so rich dependencies are binary-first where practical,
with package-manager fallback only when required.

## Changes

- Added CC_BRIDGE-owned Yazi/ya release download into
  `$XDG_DATA_HOME/cc-bridge/tools/workbench/bin`.
...
- Removed invalid CC_BRIDGE-owned Yazi/ya binaries when validation fails so normal
...
- Made rich command detection prefer the CC_BRIDGE workbench `bin` directory before
  system `PATH`.
...
/home/bfly/yunwei/cc-bridge_source/cc-bridge_test update rich
HOME=/home/bfly/yunwei/test_ccb2/source_home \
CC_BRIDGE_SOURCE_HOME=/home/bfly/yunwei/test_ccb2/source_home \
/home/bfly/yunwei/test_ccb2/source_home/.local/share/cc-bridge/tools/workbench/bin/yazi --version
HOME=/home/bfly/yunwei/test_ccb2/source_home \
CC_BRIDGE_SOURCE_HOME=/home/bfly/yunwei/test_ccb2/source_home \
/home/bfly/yunwei/test_ccb2/source_home/.local/share/cc-bridge/tools/workbench/bin/ya --version
```
...
- Initial GNU Yazi validation failed on the host with a `GLIBC_2.39`
  requirement.
- After switching Linux preference to musl, `cc-bridge_test update rich` installed
