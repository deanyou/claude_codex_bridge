...
- `command -v cc-bridge_test && cc-bridge_test --version || true` from `/home/bfly/yunwei/test_ccb2`
...
- External `cc-bridge_test`: `/tmp/cc-bridge-v7.2.1-install-smoke/prefix/cc-bridge_test`,
  release/stable `cc-bridge v7.3.5 fb12192 2026-06-07`.
...
- `agent1/provider-state/codex/home/AGENTS.md`: `command ask "$TARGET"` appears
  twice, `## CC_BRIDGE Runtime Coordination Rules` appears once, and
  `## Ask Communication` appears once.
- `archi/provider-state/codex/home/AGENTS.md`: same pattern.
- `/home/bfly/yunwei/test_ccb2/.cc-bridge/cc-bridge_memory.md` still contains old v4
