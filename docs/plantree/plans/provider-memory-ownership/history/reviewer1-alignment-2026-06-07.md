...
- `.cc-bridge/cc-bridge-daemon/artifacts/text/completion-reply/job_823610dbfaaa-art_5c2147efebae4197.txt`
...
- Codex source-home `AGENTS.md` should be treated as provider user memory and
  receive conservative CC_BRIDGE install-block filtering.
- Claude route-mode `~/.claude/rules/cc-bridge-config.md` should no longer be written
  by new installs; uninstall cleanup should continue removing known CC_BRIDGE-owned
  copies.
