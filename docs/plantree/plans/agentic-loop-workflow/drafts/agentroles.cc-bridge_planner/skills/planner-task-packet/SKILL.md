...
description: Draft CC_BRIDGE workflow task packets, readiness recommendations, and candidate clarification questions without mutating authoritative state.
---
...
Do not run shell commands, file searches, file reads, tests, builds, or CC_BRIDGE
