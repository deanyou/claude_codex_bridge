...
schema `cc-bridge.planner.frontdesk_status.v1`. Preserve
...
Always include `CC_BRIDGE_REQ_ID: <request-id>` immediately after the heading. Reuse
...
- Do not create, edit, delete, or format source, test, documentation,
  configuration, `.cc-bridge`, or runtime files.
