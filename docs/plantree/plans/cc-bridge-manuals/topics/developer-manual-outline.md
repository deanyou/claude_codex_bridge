...
`CC_BRIDGE Developer Manual: Architecture, Runtime, and Communication Internals`
...
4. Startup And Supervision
   - CLI entry, project discovery, keeper, cc-bridge-daemon, lifecycle, lease, socket,
...
6. Runtime State And Storage
   - `.cc-bridge` authority files, runtime records, provider-state, shared cache,
...
11. Testing And Source Runtime Validation
    - unit test structure, external `cc-bridge_test` validation, source/runtime
