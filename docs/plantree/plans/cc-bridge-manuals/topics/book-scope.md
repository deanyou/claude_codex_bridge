...
- maintainers who need to understand CC_BRIDGE internals;
- agents or contributors modifying cc-bridge-daemon, communication, provider backends,
  config loading, runtime state, rolepacks, diagnostics, or tests;
- reviewers who need a source-backed architecture reference.

User manual:

- users configuring CC_BRIDGE projects;
...
- The manuals should not teach users to edit runtime residue under
  `.cc-bridge/cc-bridge-daemon/` or provider session files.
