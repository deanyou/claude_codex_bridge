...
`CC_BRIDGE User Manual: Configuration, Commands, and Multi-Agent Workflows`
...
1. Getting Started
   - install/update assumptions, project anchor, first `cc-bridge` start, tmux
