...
The user requested two deep CC_BRIDGE manuals and explicitly asked to analyze before
...
- Runtime validation examples use `/home/bfly/yunwei/test_ccb2` with isolated
  ...
  `CC_BRIDGE_SOURCE_HOME=/home/bfly/yunwei/test_ccb2/source_home` unless a test is
