# CC_BRIDGE Manuals Plan

Date: 2026-06-10

## Purpose

Produce two deep CC_BRIDGE manuals from code and runtime evidence:

1. A LaTeX developer manual, roughly 100 pages, explaining CC_BRIDGE architecture,
...
Do not edit CC_BRIDGE runtime implementation files for this documentation task unless
...
- `cc-bridge_self` expert Markdown guide:
