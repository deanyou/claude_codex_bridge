...
A long-lived project running CC_BRIDGE 8.5.2 accumulated a callback edge ledger with
...
- The project cc-bridge-daemon remains the callback ledger's single runtime writer.
...
- 169 cc-bridge-daemon socket, restart, ProjectView, control-queue, retry-lineage, and
...
The code change is migration-free. Rollout requires a normal CC_BRIDGE release and a
