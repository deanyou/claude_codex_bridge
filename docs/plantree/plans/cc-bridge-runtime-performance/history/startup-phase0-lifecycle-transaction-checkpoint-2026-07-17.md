...
- keeper releases the lock before spawning or waiting for `cc-bridge-daemon`; the child
...
Contracts were updated in `docs/cc-bridge-daemon-startup-supervision-contract.md` and
