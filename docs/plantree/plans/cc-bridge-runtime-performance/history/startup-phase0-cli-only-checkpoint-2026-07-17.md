...
env -i HOME=/home/bfly/yunwei/test_ccb2/source_home \
  ...
  CC_BRIDGE_TEST_ROOTS=/home/bfly/yunwei/test_ccb2 \
  CC_BRIDGE_SOURCE_ALLOWED_ROOTS=/home/bfly/yunwei/test_ccb2 \
  PATH=/usr/local/bin:/usr/bin:/bin \
  strace -f -e trace=process \
  /home/bfly/yunwei/cc-bridge_source/cc-bridge_test --print-version
```
...
`cc-bridge ping cc-bridge-daemon` was rejected as the S0 command because its current control path
...
owner-marked external fixture, isolated `HOME`/`CC_BRIDGE_SOURCE_HOME`, deterministic
