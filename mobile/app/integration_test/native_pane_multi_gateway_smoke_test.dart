...
const _projectAlphaId = String.fromEnvironment(
  'CC_BRIDGE_MOBILE_NATIVE_ALPHA_PROJECT_ID',
);
const _projectAlphaName = String.fromEnvironment(
  'CC_BRIDGE_MOBILE_NATIVE_ALPHA_PROJECT_NAME',
  defaultValue: 'test_ccb2_alpha',
);
const _projectBetaId = String.fromEnvironment(
  'CC_BRIDGE_MOBILE_NATIVE_BETA_PROJECT_ID',
);
const _projectBetaName = String.fromEnvironment(
  'CC_BRIDGE_MOBILE_NATIVE_BETA_PROJECT_NAME',
  defaultValue: 'test_ccb2_beta',
);
const _alphaAgent = String.fromEnvironment(
  'CC_BRIDGE_MOBILE_NATIVE_ALPHA_AGENT',
  defaultValue: 'mobile_probe',
);
const _betaAgent = String.fromEnvironment(
  'CC_BRIDGE_MOBILE_NATIVE_BETA_AGENT',
  defaultValue: 'mobile_peer',
);
const _alphaPrompt = String.fromEnvironment('CC_BRIDGE_MOBILE_NATIVE_ALPHA_PROMPT');
const _alphaExpected = String.fromEnvironment(
  'CC_BRIDGE_MOBILE_NATIVE_ALPHA_EXPECTED',
);
const _betaPrompt = String.fromEnvironment('CC_BRIDGE_MOBILE_NATIVE_BETA_PROMPT');
const _betaExpected = String.fromEnvironment('CC_BRIDGE_MOBILE_NATIVE_BETA_EXPECTED');
