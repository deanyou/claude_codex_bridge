import 'cc_bridge_provider_control.dart';
...
class CcBridgeAgent {
  ...
  final CcBridgeProviderControl? providerControl;

  CcBridgeAgent copyWith({
  ...
  factory CcBridgeAgent.fromJson(Map<String, Object?> json) {
    return CcBridgeAgent(
      ...
      providerControl:
          json['provider_control'] is Map
              ? CcBridgeProviderControl.fromJson({
