...
class CcBridgeProviderControl {
  const CcBridgeProviderControl({
    ...
    this.usage,
    this.capabilities = const CcBridgeProviderCapabilities(),
  ...
  final CcBridgeProviderCapabilities capabilities;
  ...
  factory CcBridgeProviderControl.fromJson(Map<String, Object?> json) {
    return CcBridgeProviderControl(
      ...
      usage:
          json['usage'] is Map
              ? CcBridgeAgentUsage.fromJson(_map(json['usage']))
              : null,
      capabilities: CcBridgeProviderCapabilities.fromJson(
...
class CcBridgeProviderCapabilities {
  const CcBridgeProviderCapabilities({
  ...
  factory CcBridgeProviderCapabilities.fromJson(Map<String, Object?> json) {
    return CcBridgeProviderCapabilities(
...
class CcBridgeAgentUsage {
  const CcBridgeAgentUsage({
    this.inputTokens,
  ...
  factory CcBridgeAgentUsage.fromJson(Map<String, Object?> json) {
    return CcBridgeAgentUsage(
...
class CcBridgeProviderControlDetails {
  const CcBridgeProviderControlDetails({
  ...
  final CcBridgeProviderCatalog catalog;
  final String? configRevision;
  final CcBridgeProviderAccountUsage? accountUsage;

  factory CcBridgeProviderControlDetails.fromJson(Map<String, Object?> json) {
    return CcBridgeProviderControlDetails(
      ...
      control: CcBridgeProviderControl.fromJson(_map(json['provider_control'])),
      catalog: CcBridgeProviderCatalog.fromJson(_map(json['provider_catalog'])),
      configRevision: _optionalText(json['config_revision']),
      accountUsage:
          json['account_usage'] is Map
              ? CcBridgeProviderAccountUsage.fromJson(_map(json['account_usage']))
              : null,
    );
  }
}

class CcBridgeProviderSettingsResult {
  const CcBridgeProviderSettingsResult({
  ...
  factory CcBridgeProviderSettingsResult.fromJson(Map<String, Object?> json) {
...
class CcBridgeProviderCatalog {
  const CcBridgeProviderCatalog({
    required this.provider,
    this.models = const [],
  ...
  final String provider;
  final List<CcBridgeProviderModel> models;
  final String modelSource;
  final bool modelSelectable;
  final bool customModel;
  final bool staticThinking;

  factory CcBridgeProviderCatalog.fromJson(Map<String, Object?> json) {
    return CcBridgeProviderCatalog(
      provider: _text(json['id']),
      models: [
        for (final item in _mapList(json['models']))
          CcBridgeProviderModel.fromJson(item),
      ],
...
class CcBridgeProviderModel {
  const CcBridgeProviderModel({
    required this.id,
    required this.label,
    this.description,
  ...
  factory CcBridgeProviderModel.fromJson(Map<String, Object?> json) {
    return CcBridgeProviderModel(
      id: _text(json['id']),
...
class CcBridgeProviderAccountUsage {
  const CcBridgeProviderAccountUsage({
    required this.provider,
    required this.status,
    this.planLabel,
    this.windows = const [],
  ...
  final List<CcBridgeProviderUsageWindow> windows;
  final List<CcBridgeProviderUsageBalance> balances;
  final List<CcBridgeProviderUsageDetail> details;
  final DateTime? fetchedAt;
  final DateTime? nextRefreshAt;
  final String? error;

  factory CcBridgeProviderAccountUsage.fromJson(Map<String, Object?> json) {
    return CcBridgeProviderAccountUsage(
      ...
      windows: [
        for (final item in _mapList(json['windows']))
          CcBridgeProviderUsageWindow.fromJson(item),
      ],
      balances: [
        for (final item in _mapList(json['balances']))
          CcBridgeProviderUsageBalance.fromJson(item),
      ],
      details: [
        for (final item in _mapList(json['details']))
          CcBridgeProviderUsageDetail.fromJson(item),
      ],
...
class CcBridgeProviderUsageWindow {
  const CcBridgeProviderUsageWindow({
    required this.id,
    required this.label,
    this.usedPct,
    this.remainingPct,
  ...
  factory CcBridgeProviderUsageWindow.fromJson(Map<String, Object?> json) {
    return CcBridgeProviderUsageWindow(
      id: _text(json['id']),
...
class CcBridgeProviderUsageBalance {
  const CcBridgeProviderUsageBalance({
    required this.id,
    required this.label,
    this.remaining,
    this.unit,
  ...
  factory CcBridgeProviderUsageBalance.fromJson(Map<String, Object?> json) {
    return CcBridgeProviderUsageBalance(
      id: _text(json['id']),
      label: _text(json['label']),
...
class CcBridgeProviderUsageDetail {
  const CcBridgeProviderUsageDetail({
    required this.id,
    required this.label,
    required this.value,
  });
  ...
  factory CcBridgeProviderUsageDetail.fromJson(Map<String, Object?> json) {
    return CcBridgeProviderUsageDetail(
      id: _text(json['id']),
      label: _text(json['label']),
