...
- App: current `cc-bridge_mobile` worktree debug APK built and installed on
  `emulator-5554`.
- Gateway: `/home/bfly/yunwei/cc-bridge_source_mobile_update_simple/cc-bridge_test install mobile`
...
- Project list: real server-wide projects, including `cc-bridge_mobile`,
  `cc-bridge_source`, `test_ccb2`, `test_ccb2_alpha`, and `test_ccb2_beta`.
...
- Phone send used the pane-backed path: the sent text appeared as the exact
  user input without adding a new `CC_BRIDGE_REQ_ID`, `mobile_gateway`, or ask-job
  wrapper.
...
- `/tmp/cc-bridge_after_reinstall.png`
- `/tmp/cc-bridge_testroot_open.png`
- `/tmp/cc-bridge_new_probe_after_send.png`
- `/tmp/cc-bridge_new_probe_after_wait.png`
- `/tmp/cc-bridge_new_probe_after_wait.xml`
