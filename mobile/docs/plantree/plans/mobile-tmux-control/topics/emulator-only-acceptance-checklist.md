...
unmounted the disposable CC_BRIDGE runtime.
...
stopped gateway, and unmounted the disposable CC_BRIDGE runtime.
...
| Isolated CC_BRIDGE runtime | Accepted | Both smokes created disposable projects under `/home/bfly/yunwei/test_ccb2`, started CC_BRIDGE, and unmounted via cleanup. | Normal AVD smoke command above. |
...
| Safe lifecycle controls | Accepted | Normal AVD smoke covers wake/open/close; stop smoke covers confirmed stop in a throwaway runtime; source/app commits `e1ace0b0`, `b8d9507`, and `f08754f` enforce CC_BRIDGE authority and no raw tmux kill. | Normal and stop AVD smoke commands above. |
