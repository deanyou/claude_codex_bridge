...
EXPECTED_STARTUP_ID_ENV = 'CC_BRIDGE_CC_BRIDGE_DAEMON_EXPECTED_STARTUP_ID'
EXPECTED_GENERATION_ENV = 'CC_BRIDGE_CC_BRIDGE_DAEMON_EXPECTED_GENERATION'
KEEPER_STARTUP_ACCEPTED_PERF_COUNTER_NS_ENV = (
    'CC_BRIDGE_CC_BRIDGE_DAEMON_KEEPER_STARTUP_ACCEPTED_PERF_COUNTER_NS'
)
