...
from cc_bridge_daemon.services.project_namespace_pane import backend_socket_matches, inspect_project_namespace_pane, same_tmux_socket_path
...
def _record_matches_runtime_window(runtime, record) -> bool:
    ...
    if window_name is None:
        return False
    for field_name in ('cc_bridge_window', 'window_name'):
