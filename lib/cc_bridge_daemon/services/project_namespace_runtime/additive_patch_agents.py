...
from cc_bridge_daemon.reload_additive_agents import append_agent_plan_for_window, append_agent_windows, window_agent_names, window_map
...
def _append_window_agent_panes(
    ...
    *,
    ...
    for index, appended in enumerate(appended_sequence):
        ...
        # 如 Main_Code，而 CC_BRIDGE 内部 agent 标识是 main_code）——否则大小写敏感匹配下
