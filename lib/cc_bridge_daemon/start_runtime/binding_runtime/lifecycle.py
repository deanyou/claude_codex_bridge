...
def relabel_project_namespace_pane(
    *,
    ...
    same_tmux_socket_path_fn,
    apply_cc_bridge_pane_identity_fn,
    ...
    if cc_bridge_session_id:
        identity_kwargs['session_id'] = cc_bridge_session_id
    apply_cc_bridge_pane_identity_fn(backend, pane_id, **identity_kwargs)
    return pane_id
