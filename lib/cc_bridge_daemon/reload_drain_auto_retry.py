...
from cc_bridge_daemon.reload_apply_service import current_namespace_for_apply, run_additive_reload_apply
from cc_bridge_daemon.reload_drain import DrainRecord, plan_drain_transition, retire_record
...
def _auto_retry_enabled() -> bool:
    raw = str(os.environ.get('CC_BRIDGE_CC_BRIDGE_DAEMON_RELOAD_DRAIN_AUTO_RETRY') or '').strip().lower()
