...
from cc_bridge_daemon.start_flow_runtime import StartFlowDeps, StartFlowSummary, run_start_flow as run_start_flow_impl
from cc_bridge_daemon.start_preparation import prepare_start_agents
from cc_bridge_daemon.start_runtime.agent_runtime import start_agent_runtime as start_agent_runtime_impl
from cc_bridge_daemon.start_runtime.binding import declared_binding_tmux_socket_path as declared_binding_tmux_socket_path_impl
from cc_bridge_daemon.start_runtime.binding import launch_binding_hint as launch_binding_hint_impl
from cc_bridge_daemon.start_runtime.binding import relabel_project_namespace_pane as relabel_project_namespace_pane_impl
from cc_bridge_daemon.start_runtime.binding import usable_agent_only_project_binding as usable_agent_only_project_binding_impl
from cc_bridge_daemon.start_runtime.binding import usable_project_binding as usable_project_binding_impl
from cc_bridge_daemon.start_runtime.binding import usable_project_namespace_binding as usable_project_namespace_binding_impl
from cc_bridge_daemon.start_runtime.cleanup import cleanup_start_tmux_orphans as cleanup_start_tmux_orphans_impl
from cc_bridge_daemon.start_runtime.layout import bootstrap_project_namespace_cmd_pane as bootstrap_project_namespace_cmd_pane_impl
from cc_bridge_daemon.start_runtime.layout import cmd_bootstrap_command as cmd_bootstrap_command_impl
from cc_bridge_daemon.start_runtime.layout import inside_tmux as inside_tmux_impl
from cc_bridge_daemon.start_runtime.layout import prepare_start_layout as prepare_start_layout_impl
from cc_bridge_daemon.start_runtime.layout import session_root_pane as session_root_pane_impl
from cc_bridge_daemon.start_runtime.restore import build_restore_state as build_restore_state_impl
from cc_bridge_daemon.system import utc_now
from cc_bridge_daemon.services.project_namespace_pane import inspect_project_namespace_pane, same_tmux_socket_path
...
def _deps() -> StartFlowDeps:
    return StartFlowDeps(
        ...
        apply_cc_bridge_pane_identity_fn=apply_cc_bridge_pane_identity,
    )
