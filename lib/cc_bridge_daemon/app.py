...
from cc_bridge_daemon.app_runtime.lifecycle import DEFAULT_CC_BRIDGE_DAEMON_POLL_INTERVAL_S
from cc_bridge_daemon.app_runtime import (
...
class CcbdApp:
    ...
    def _register_handlers(self) -> None:
        from cc_bridge_daemon.app_runtime.handlers import register_handlers
    ...
    def serve_forever(self, *, poll_interval: float = DEFAULT_CC_BRIDGE_DAEMON_POLL_INTERVAL_S) -> None:
