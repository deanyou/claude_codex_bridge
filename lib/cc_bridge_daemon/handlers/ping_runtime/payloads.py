...
def build_agent_payload(*, project_id: str, agent_name: str, registry, inspection, execution_registry) -> dict:
    ...
    diagnostics = {
        'cc_bridge_daemon_generation': inspection.generation,
...
def build_cc_bridge_daemon_payload(
    *,
    project_id: str,
    config,
    paths,
    ...
    payload = {
        ...
        'tmux_socket_path': paths.cc_bridge_daemon_tmux_socket_placement.effective_path.as_posix(),
        **(paths.runtime_state_payload() if hasattr(paths, 'runtime_state_payload') else {}),
        **socket_placement_payload(paths.cc_bridge_daemon_socket_placement),
        **socket_placement_payload(paths.cc_bridge_daemon_tmux_socket_placement, prefix='tmux'),
    ...
    herdr_projection = _cc_bridge_daemon_herdr_surface_projection(
...
def _cc_bridge_daemon_herdr_surface_projection(
    *,
    namespace_summary: dict,
    restore_summary: dict,
    namespace_event_summary: dict,
...
__all__ = ['build_agent_payload', 'build_cc_bridge_daemon_payload']
