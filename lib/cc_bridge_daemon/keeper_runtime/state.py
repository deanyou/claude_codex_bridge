...
from cc_bridge_daemon.system import parse_utc_timestamp, process_exists
...
def _is_keeper_entrypoint_arg(value: str) -> bool:
    ...
    return normalized == 'cc_bridge_daemon.keeper_main' or normalized.endswith('/cc_bridge_daemon/keeper_main.py')
