...
from cc_bridge_daemon.models import CcbdShutdownReport, CcbdStartupReport, cleanup_summaries_from_objects
    ...
    try:
        ...
        report = CcbdStartupReport(
            ...
            socket_placement={
                ...
                **socket_placement_payload(supervisor._paths.cc_bridge_daemon_socket_placement),
                **socket_placement_payload(supervisor._paths.cc_bridge_daemon_tmux_socket_placement, prefix='tmux'),
            },
            restore_summary={},
