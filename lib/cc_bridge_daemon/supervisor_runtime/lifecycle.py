...
from cc_bridge_daemon.services import CcbdLifecycleStore
    ...
    try:
        ...
        if (
            ...
            topology_plan = build_namespace_topology_plan(
                supervisor._config,
                cc_bridge_daemon_socket_path=str(supervisor._paths.cc_bridge_daemon_socket_path),
        ...
        if readiness_recorder is not None:
            if (
                ...
                readiness_recorder.mark(
                    ...
                    source='cc_bridge_daemon_namespace_ensure_current_generation',
                ...
                readiness_recorder.mark(
                    ...
                    source='cc_bridge_daemon_namespace_unavailable',
                    now_ns=time.perf_counter_ns(),
                )
...
def _failure_agent_results(exc: Exception) -> tuple[CcbdStartupAgentResult, ...]:
    value = getattr(exc, 'cc_bridge_startup_agent_results', ())
